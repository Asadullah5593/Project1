                ...
                <div className="container">
                    <div className="section-title text-center">
                        ...
                        <p>If you have any queires or questions, a member of our staff will always be happy to help.
                            Feel free to contact us by telephone or email and we will be sure to get back to you as soon
                            as possible..</p>
                    </div>
                    <div className="row">
                                ...
                                <form className='form-type'>
                                    <div className="row">
                                        <div className="form-group col-md-6">
                                            <input className="contact-input-field" type="text" name="name"
                                        ...
                                        <div className="col-md-12 text-center">
                                            <button type="submit" value="Send message" name="submit" id="submitButton"
                                                    className="btn btn-danger" title="Submit Your Message!">Send Message
                                            </button>
                                        </div>
                                    </div>
                                </form>
