...
<div className="container d-flex justify-content-center mt-50 mb-50">
        ...
        <div className="col-md-4 mt-2">
            ...
            <div className="card-body bg-light text-center">
                ...
                <div className="text-muted mb-3">30 reviews</div>
                    <button type="button" className="bg-cart"><FontAwesomeIcon icon={faCartPlus} mr-2/> Add to cart</button>                        
                    </div>
            </div>           
               </div> 
               <div className="col-md-4 mt-2">
               ...
               <div className="col-md-4 mt-2">
                <div className="card">
                    <div className="card-body">
                        <div className="card-img-actions">
                        <img src={product3pic} className="card-img img-fluid" width="96" height="350" alt="product3"/>
                        </div>
                    </div>
                        <div className="card-body bg-light text-center">
                            <div className="mb-2">
                    ...
                    <div class="text-muted mb-3">101 reviews</div>
                    <button type="button" className="bg-cart"><FontAwesomeIcon icon={faCartPlus} mr-2/> Add to cart</button>
                    </div>
                </div>
            </div>
                <div className="col-md-4 mt-2">
                    <div className="card">
                        <div className="card-body">
                            <div className="card-img-actions">
                                <img src={product4pic} className="card-img img-fluid" width="96" height="350" alt="product4"/>
                            </div>
                        </div>
                            <div className="card-body bg-light text-center">
                                <div className="mb-2">
                    ...
                    <div className="card">
                        <div className="card-body">
                            <div className="card-img-actions">
                            <img src={product5pic} className="card-img img-fluid" width="96" height="350" alt="product5"/>
                            </div>
                                </div>
                            <div className="card-body bg-light text-center">
                                <div className="mb-2">
    ...
    <div className="col-md-4 mt-2">
        <div className="card">
            <div className="card-body">
                <div className="card-img-actions">
                <img src={product6pic} className="card-img img-fluid" width="96" height="350" alt="product6"/>
                </div>
            </div>
        <div className="card-body bg-light text-center">
            <div className="mb-2">
